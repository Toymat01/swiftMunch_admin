...
const Driver = () => {
  ...
  return <>
    ...
    <div className="top flex items-center justify-between">
        <div className="left">
          <h1 className="text-2xl font-semibold text-grey3">Drivers</h1>
          <p className="text-[#A3A3A3] text-sm mt-1">View all drivers on SwiftMunch Admin!!</p>
        </div>
        <div className="flex w-[28%] justify-between">
          ...
          <button className="more_options flex items-center border border-[#E81C4E] rounded-lg px-3 py-2 text-[0.9rem] font-semibold text-[#E81C4E] hover:bg-[#E81C4E] hover:text-white" >
            <FiPlus size={"1rem"} /> <span>Add Driver</span>
          </button>
        </div>
      ...
      <div>
        <div className=" top flex justify-between mt-10 mb-8 flex-col">
          <div className="flex justify-between items-center">
            <h3 className="text-base font-semibold text-grey3 ">All Drivers</h3>
