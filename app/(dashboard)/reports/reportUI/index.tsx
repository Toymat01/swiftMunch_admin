...
const Report = () => {
  const ordersHeader = [
    "ID", "Address",  "Email Address", "User","Pick-Up Commision", "Delivery Commision", "Revenue", "Status", "Action"
  ]
  ...
  return <>
    ...
    <main className="w-[95%] mx-auto mt-8">
      <div className="top flex items-center justify-between">
        <div className="left">
          <h1 className="text-2xl font-semibold text-grey3">Reports</h1>
          <p className="text-[#A3A3A3] text-sm mt-1">View all reports on SwiftMunch Admin!</p>
        </div>
        <div className="flex w-[28%] gap-x-4 justify-end">
          ...
          <button className="more_options flex items-center border border-[#E81C4E] rounded-lg px-3 py-2 text-[0.9rem] font-semibold text-[#E81C4E] hover:bg-[#E81C4E] hover:text-white" >
            <FiPlus size={"1rem"} /> <span>Download Data</span>
          </button>
          <PrimaryButton isOutline="yes" content="Reset"/>
        </div>
        ...
        <div className=" top flex justify-between mt-10 mb-8 flex-col">
          <div className="flex justify-between items-center w-1/3">
            <input
              type="search"
              id="default-search"
              className="block basis-[55%] py-2 pl-4 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border dark:placeholder-gray-300 dark:text-white "
              placeholder="Search by ID/Customer's name"
              required />
          </div>
          <div className="my-10">
